...
nnoremap <Leader>cd :cd <C-r>=fnameescape(myproject#project_dir())<CR>
nnoremap <Leader>td :tcd <C-r>=fnameescape(myproject#project_dir())<CR>
nnoremap <Leader>ld :lcd <C-r>=fnameescape(myproject#project_dir())<CR>
